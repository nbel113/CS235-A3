...
#Movie
    def test_movie_init_basic(self):
        movie = Movie("Moana", 2016)
        assert repr(movie) == "<Movie Moana, 2016>"
    def test_movie_fail_no_name(self):
        movie = Movie("", 2016)
        assert repr(movie) == "<Movie None, None>"
    def test_movie_fail_too_old(self):
        movie = Movie("Moana", 1886)
        assert repr(movie) == "<Movie None, None>"
    def test_movie_no_description(self):
        movie = Movie("Moana", 2016)
        assert movie.description == ""
    def test_movie_set_description(self):
        movie = Movie("Moana", 2016)
        movie.description = "   This is a movie   "
        assert movie.description == "This is a movie"
    def test_movie_set_director(self):
        movie = Movie("Moana", 2016)
        movie.description = "   This is a movie   "
        assert movie.description == "This is a movie"
    ...
    def test_movie_set_genres(self):
        movie = Movie("Moana", 2016)
        movie.description = "   This is a movie   "
        assert movie.description == "This is a movie"
        movie.director = Director("Ron Clements")
    ...
    def test_movie_delete_stuff(self):
        movie = Movie("Moana", 2016)
        movie.description = "   This is a movie   "
        assert movie.description == "This is a movie"
        movie.director = Director("Ron Clements")
...
#Watchlist
    ...
    def test_watchlist_valid_select(self):
        watchlist = WatchList()
        watchlist.add_movie(Movie("Moana", 2016))
        watchlist.add_movie(Movie("Ice Age", 2002))
        watchlist.add_movie(Movie("Guardians of the Galaxy", 2012))
    ...
    def test_watchlist_iter_invalid(self):
        watchlist = WatchList()
        watchlist.add_movie(Movie("Moana", 2016))
        watchlist.add_movie(Movie("Ice Age", 2002))
        watchlist.add_movie(Movie("Guardians of the Galaxy", 2012))
...
#Watching Simulator
    ...
    def test_watching_sim_review_average(self):
        ...
        assert a.get_movie_rating_average( Movie("Ice Age", 2003) ) == "Unrated: No Reviews"